            ...
            child: Builder(
                builder: (ctx) => InkWell(
                      ...
                      child: Builder(builder: (context) {
                        return Hero(
                          tag: images.indexOf(widget.element),
                          child: PhotoView(
                    ...
                    PhotoViewGallery.builder(
                      ...
                      builder: (context, index) => PhotoViewGalleryPageOptions(
                        errorBuilder: (context, error, stackTrace) => Center(
                          child: ElevatedButton(
                            onPressed: () {
                              images[images.indexOf(widget.images[index])]
                                  .localUrl = 'assets/images/a.png';
                              setState(() {});
                            },
                            style: ElevatedButton.styleFrom(
                        ...
                        imageProvider:
                            AssetImage(widget.images[index].localUrl),
                        ...
                        heroAttributes: PhotoViewHeroAttributes(
                            tag: widget.images.indexOf(widget.images[index])),
                      ),
                      onPageChanged: (index) {
                        this.index = index;
                        setState(() {});
